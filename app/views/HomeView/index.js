        ...
        <ScrollView style={{ flexGrow: 1 }}>
         ...
         <ActivityIndicator absolute theme={"light"} size={'large'}  />
          ...
          <View style={styles.btnContainer}>
            <BuyButton name={'Buy Investment'} key ={1} />
            <BuyButton name={'Buy Blockchain'} key ={2}/>
            <BuyButton name={'Buy Products'} key ={3}/>
          </View>
          <View style = {styles.cardItems}>
          <CardDataItem name = {'Blockchain'} />
          </View>
          <CardDataItem name = {'Associated'} key ={1}/>
          <CardDataItem name = {'Products'} key ={2}/>
          {/* <RecentActivity /> */}
        </ScrollView>
      </ImageBackground>
    </MainScreen>
